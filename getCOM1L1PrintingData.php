...
require_once "main.php";
	...
	{
		$printerRow = (int)Printer::rowCount("SELECT COUNT(*) FROM COM1_L1_A4 where status='printing' or status='ready'");
	}

	$printerResults = Printer::sqlQuery("SELECT * FROM COM1_L1_A4 where (status='printing') or (status='ready') ");
