...
require_once "main.php";
	...
	{
		$printerRow = (int)Printer::rowCount("SELECT COUNT(*) FROM YIH_CBLC_A4 where status='printing' or status='ready'");
	}

	$printerResults = Printer::sqlQuery("SELECT * FROM YIH_CBLC_A4 where (status='printing') or (status='ready') ");
